...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-main sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= $baseUrl; ?>customer">
        ...
        <li class="nav-item">
            <a class="nav-link" href="<?= $baseUrl; ?>customer/orders">
                <i class="fas fa-fw fa-pizza-slice"></i>
                <span>Orders</span></a>
        </li>

        <li class="nav-item">
            <a class="nav-link" href="<?= $baseUrl; ?>customer/search?q=">
                <i class="fas fa-utensils"></i>
                <span>Menu</span></a>
        </li>

        <li class="nav-item">
            <a class="nav-link" href="<?= $baseUrl; ?>customer/cooks?q=">
                <i class="fas fa-temperature-high"></i>
                <span>Cooks</span></a>
        </li>

        <li class="nav-item">
            <a class="nav-link" href="<?= $baseUrl; ?>customer/order-history">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown no-arrow">
                        ...
                        <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                            ...
                            <a class="dropdown-item" href="<?= $baseUrl; ?>customer/profile">
