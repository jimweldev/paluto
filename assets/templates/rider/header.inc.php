...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-main sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= $baseUrl; ?>rider">
        ...
        <li class="nav-item">
            <a class="nav-link" href="<?= $baseUrl; ?>rider">
                <i class="fas fa-fw fa-motorcycle"></i>
                <span>My Deliveries</span></a>
        </li>

        <li class="nav-item">
            <a class="nav-link" href="<?= $baseUrl; ?>rider/deliveries-page">
                <i class="fas fa-fw fa-file"></i>
                <span>Deliveries Page</span></a>
        </li>

        <li class="nav-item">
            <a class="nav-link" href="<?= $baseUrl; ?>rider/delivery-history">
                <i class="fas fa-fw fa-history"></i>
                <span>Delivery History</span></a>
        </li>

        <li class="nav-item">
            <a class="nav-link" href="<?= $baseUrl; ?>rider/buy-load">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown no-arrow">
                        ...
                        <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                            ...
                            <a class="dropdown-item" href="<?= $baseUrl; ?>rider/profile">
